...
//        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10)); // esperas a nivel global para no tener que aplicarlas manualmente
    }
...
//        );
        ...
        // Opción 3: Action con waits para evitar des-sincronización de comprobar algo que todavía no haya dado tiempo a que se ejecute
        WebElement lesson = driver.findElement(By.cssSelector("a[title='Introducción a Selenium']"));
...
//                    new Actions(driver).moveToElement(lesson).perform();
        ...
        // POSIBLE PROBLEMA: CertiDevs tiene una segunda navbar dinámica que se muestra solo en algunos casos pero puede estar interfiriendo
//        WebElement lesson = driver.findElement(By.cssSelector("a[title='Introducción a Selenium']"));
