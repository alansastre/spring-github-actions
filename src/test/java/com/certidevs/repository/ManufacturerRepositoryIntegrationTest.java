...
class ManufacturerRepositoryIntegrationTest {
    ...
    void findByNameIgnoreCase() {
        ...
        // 3. Ejecutar el método a probar con un nombre en mayúsculas
        List<Manufacturer> manufacturers = manufacturerRepository.findByNameIgnoreCase("FABRICANTE X");

        // 4. Verificar el resultado
        assertEquals(2, manufacturers.size(), "Debería encontrar 2 fabricantes con nombre 'Fabricante X'");
    ...
    void existsByName() {
        // 1. Preparar los datos de prueba: crear un fabricante
        Manufacturer manufacturer = Manufacturer.builder()
                .name("Existente")
                .build();

        // 2. Guardar el fabricante en la base de datos
        ...
        // 4. Verificar que un fabricante no existente devuelve false
    ...
    void findByName() {
        // 1. Preparar los datos de prueba: crear fabricantes con el mismo nombre
        Manufacturer manufacturer1 = Manufacturer.builder()
                .name("Fabricante Z")
                .build();
        ...
        // 4. Verificar el resultado
        assertEquals(2, manufacturers.size(), "Debería encontrar 2 fabricantes con nombre 'Fabricante Z'");
        assertTrue(manufacturers.contains(manufacturer1));
        assertTrue(manufacturers.contains(manufacturer2));
    }
    ...
    void findAllWithCalculatedProductsStats() {
        ...
        Manufacturer manufacturer = Manufacturer.builder()
                ...
                .year(2024)
                .imageUrl("https://example.com/manufacturer-a.png")
                .build();
        manufacturerRepository.save(manufacturer); // Guarda el fabricante en la base de datos

        // Crear tres productos asociadados al fabricante creado
        ...
        // Verificar que la suma total de precios de productos es 150.0
        assertEquals(150.0, dto.productsSumTotalPrice(),
                0.001, "La suma total de precios de los productos debería ser 150.0");

        // Impresión de resultados (Opcional)
        System.out.println("Resultado de la consulta JPQL:");
        System.out.println("ID fabricante: " + dto.manufacturerId());
        System.out.println("Nombre fabricante: " + dto.manufacturerName());
    ...
    void findByAddress_Id() {
        // 1. Preparar datos de prueba: crear Address y Manufacturer asociados
