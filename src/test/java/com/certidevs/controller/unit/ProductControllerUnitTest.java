...
//        verify(model).addAttribute("message", "Producto no encontrado");
    ...
    void obtenerFormularioParaEditarProducto_Exists() {
        ...
        String view = productController.obtenerFormularioParaEditarProducto(model, 1L);
    ...
    /**
     * Metodo {@link ProductController#obtenerFormularioParaEditarProducto(Model, Long)}
     */
    @Test
    ...
    @Test
    @DisplayName("Testear que controller captura la excepción")
    void borrarProducto_ErrorCapturado() {

        // simulamos que el mock lanza una excepción
