...
public interface ManufacturerRepository extends JpaRepository<Manufacturer, Long> {
    ...
    """)
    List<ManufacturerWithAddressDTO> findManufacturersInCityWithProductStats(@Param("city") String city); // Método que ejecuta la consulta y devuelve una lista de ManufacturerWithAddressDTO
